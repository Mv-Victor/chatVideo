...
- **FR-006**: Timeline clips MUST be draggable (reorder), trimmable (in/out point
  ...
  per-track volume slider (range 0.0–2.0, default 1.0 for V1, 2.0 for A1, and 0.25 for A2,
