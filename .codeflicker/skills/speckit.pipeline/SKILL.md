...
for f in specify homer plan tasks lisa ralph; do
  test -f ".codeflicker/agents/${f}.md" && echo "${f}.md: EXISTS" || echo "${f}.md: MISSING"
done
```
...
Missing: .codeflicker/agents/<name>.md
...
the behavior of each pipeline phase. Ensure all agent files are present:
  .codeflicker/agents/specify.md
  .codeflicker/agents/homer.md
  .codeflicker/agents/plan.md
  .codeflicker/agents/tasks.md
  .codeflicker/agents/lisa.md
  .codeflicker/agents/ralph.md
```
...
- Instruct the agent to read and follow the corresponding agent file from `.codeflicker/agents/`
- When those instructions reference a slash command (e.g., `/speckit.clarify`), read the corresponding folds and files from `.codeflicker/skills/` and follow its instructions directly
...
- **agent file**: `.codeflicker/agents/specify.md`
...
- **subagent_type**: `general-purpose`
- **agent file**: `.codeflicker/agents/homer.md`
...
- **subagent_type**: `general-purpose`
- **agent file**: `.codeflicker/agents/plan.md`
...
- **subagent_type**: `general-purpose`
- **agent file**: `.codeflicker/agents/tasks.md`
...
- **subagent_type**: `general-purpose`
- **agent file**: `.codeflicker/agents/lisa.md`
...
- **subagent_type**: `general-purpose`
- **agent file**: `.codeflicker/agents/ralph.md`
